  ...
  return (
    <div className={`sticky bottom-4 left-0 right-0 z-50 mx-auto h-[48px] w-[200px] transition-all duration-500 focus-within:w-[355px] hover:scale-105 focus-within:hover:scale-100 ${
      ...
      <form className="relative" onSubmit={handleSubmit}>
        <label className="shadow-black-4 bg-[rgba(32,32,32,0.8)] relative flex w-full rounded-[24px] p-2 shadow-sm backdrop-blur-xl">
          <input
        ...
        <button
          className="bg-primary-100 text-black disabled:bg-primary-44 disabled:text-primary-60 absolute right-2 top-2 h-8 w-8 flex-none rounded-full p-0 hover:opacity-70 disabled:hover:opacity-100"
          type="submit"
